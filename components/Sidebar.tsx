...
const Sidebar = () => {
  ...
  const normalLink =
    "flex items-center gap-3 hover:bg-primary p-3 justify-center xl:justify-strat cursor-pointer font-semibold text-[#f51997] rounded";
